    ...
    namespace V2 {
        ...
        namespace SchemaJson {
            namespace Definitions {
                ...
                export type Description = JsonSchemaOrg.Draft04.Schema.Properties.Description;
                ...
                type methodsT = 'all' | 'get' | 'post' | 'put' | 'delete' | 'patch' | 'options' | 'head' |
                 ...
                 */
                export type Paths = { [path: string]: {[methods in methodsT]: Operation } }
                ...
                export type Title = JsonSchemaOrg.Draft04.Schema.Properties.Title;
